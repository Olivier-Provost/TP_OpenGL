...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/j14exampratique_olivier_provost: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/j14exampratique_olivier_provost ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/Plateau.o: Plateau.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Plateau.o Plateau.cpp
...
${OBJECTDIR}/SkyBox.o: SkyBox.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SkyBox.o SkyBox.cpp
